...
'''
Author       : 小鹿撞路
Date         : 2021-09-26 16:30:30
LastEditTime : 2021-09-26 17:03:36
LastEditors  : 小鹿撞路
Description  : admin
FilePath     : \python_study\admin.py
...
second_admin = Admin('ryan', 'goslin')
second_admin.add_privileges('can unlock user', 'can group email')
